...
Tired of switching to Astarion every time you find a chest?
...
This mod *only* affects lockpicking and trap disarming. It does *not* share skills in dialogue or any other ability checks. It does *not* change the target DC, create extra Thieves' Tools or Trap Disarm Toolkits, let you fail the check without using tools, bypass the roll, or force success. In other words, you won't feel like you're cheating.
...
*Auto Lockpicking*'s implementation is, in Volitio's own words, "shitty" (sorry) and works very inconsistently, or not at all for some people on the latest patch (me).
